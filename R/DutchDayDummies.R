...
#'
#' @section Non-official dutch holidays:
...
#' \code{\link[DutchDayDummies]{get_wday_before_dates}} \cr
#' \code{\link[DutchDayDummies]{ummalqura_algorithm}} \cr
#' \code{\link[DutchDayDummies]{gauss_easter_algorithm}} \cr
#'
#' @docType package
#' @name DutchDayDummies
NULL
#> NULL
