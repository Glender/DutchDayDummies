...
cat(
	...
	badger::badge_codefactor("Glender/DutchDayDummies"),
	badger::badge_lifecycle("maturing", "blue"),
	badger::badge_github_actions("Glender/DutchDayDummies"),
	badger::badge_codecov("Glender/DutchDayDummies"),
...
The documentation of all functions can be accessed by `?<function-name>` or navigate via the package documentation page `package?DutchDayDummies`.
```
# For example:
?ummalqura_algorithm
```
